...
alert ( number_2 + number_3 + " a soma dos dois valores maiores")
}
else if (number_2 < number_1 && number_2 < number_3 ) {
    alert ( number_1 + number_3 + " a soma dos dois valores maiores")
    
    }
else if (number_3 < number_1 && number_3 < number_2 ) {
        alert ( number_2 + number_1 + " a soma dos dois valores maiores")
        }
else {
